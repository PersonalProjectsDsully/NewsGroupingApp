...
def insert_entity(
    entity_name, entity_type, description=None, db_path="db/news.db", cursor=None
):
...
def link_entity_to_group(
    group_id, entity_id, relevance_score=1.0, db_path="db/news.db", cursor=None
):
...
def link_entity_to_trend(
    trend_id, entity_id, relevance_score=1.0, db_path="db/news.db", cursor=None
):
...
def insert_article_cve(
    article_id, cve_id, published_date, db_path="db/news.db", cursor=None
):
