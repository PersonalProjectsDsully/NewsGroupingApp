...
from news_grouping_app.article_signature import generate_article_signature, calculate_signature_similarity
...
try:
    ...
    logging.error(
        f"Failed to import generate_article_signature from news_grouping_app.article_signature.py: {e}",
        exc_info=True,
    )
